...
C:/Bitnami/wampstack-5.6.28-1/apache2/htdocs
...
You should copy the "demo" folder into the C:/Bitnami/wampstack-5.6.28-1/apps 
folder and add the following line at the end of the
C:/Bitnami/wampstack-5.6.28-1/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "C:/Bitnami/wampstack-5.6.28-1/apps/demo/conf/httpd-prefix.conf"
...
configuration in the "C:/Bitnami/wampstack-5.6.28-1/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "C:/Bitnami/wampstack-5.6.28-1/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"C:/Bitnami/wampstack-5.6.28-1/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "C:/Bitnami/wampstack-5.6.28-1/apps/demo/conf/httpd-vhosts.conf"
