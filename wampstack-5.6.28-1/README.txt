...
path will be a folder at C:\Bitnami\wampstack-5.6.28-1. If the destination 
...
C:\Bitnami\wampstack-5.6.28-1 and that you use port 80 for Apache and 3306 for MySQL.
